  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        variants={motionEnabled ? heroImageSequence : undefined}>
        <motion.div
          className='grid grid-cols-12 lg:flex lg:flex-col gap-4'
        ...
        <motion.div
          className='grid grid-cols-12 gap-4 lg:items-stretch xl:items-end lg:pt-20 xl:pt-0'
          variants={motionEnabled ? fadeUp : undefined}>
          ...
          <motion.div
            className='lg:hidden xl:block col-span-12 sm:col-span-4 xl:col-span-4'
            variants={motionEnabled ? fadeUp : undefined}>
        ...
        <motion.div
          className='grid grid-cols-12 lg:flex flex-col gap-4'
