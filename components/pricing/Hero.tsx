    ...
    <div className="w-full pt-24 pb-10 lg:pt-0 px-4 md:px-8 xl:px-0">
      <section>
        <div className="mx-auto flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-16">
          {/* LEFT CONTENT */}
          <div className="max-w-[567px] relative z-10">
            ...
            <p className="mt-2 xl:mt-6 text-gray-500 max-w-60 min-[600px]:max-w-[764px] mx-auto lg:text-base lg:leading-6 xl:text-lg leading-relaxed min-[600px]:pr-32 xl:pr-16 text-center min-[600px]:text-left">
